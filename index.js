...
const mongoURI =
  "mongodb+srv://aniket:1q2w3e4r5t@cluster0.2dal9.mongodb.net/bck?retryWrites=true&w=majority";
...
app.get("/", (req, res) => {
  res.send("Hello World Simran weds alok!");
});
...
app.get("/protected", authenticate, (req, res) => {
  res.send({ message: `Welcome ${req.user.email}!`, status: "200" });
});
